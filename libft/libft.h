...
t_list			**ft_get_mem_handlers(void);
t_bool			ft_mem_init(void);
void			*ft_mem_alloc(const size_t size);
void			ft_mem_free(void *ptr);
void			*ft_mem_free_all(void);
void			ft_free_mem_handler(void *content, size_t content_size);
